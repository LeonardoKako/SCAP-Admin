...
const Sidebar = () => {
  ...
  return (
    <aside className='w-64 bg-green-100 h-screen sticky top-0 flex-col py-6 border-r-0 shrink-0 hidden md:flex'>
      <div className='px-6 mb-8'>
        <NavLink to='/dashboard' className='flex items-center gap-3 mb-1 group'>
          ...
          <h1 className='font-headline text-xl font-extrabold text-slate-900 group-hover:text-primary transition-colors'>
            SCAP Admin
          </h1>
        </NavLink>
