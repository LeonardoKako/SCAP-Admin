import { Bell, History, HelpCircle } from 'lucide-react';
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 border-l border-slate-200 pl-4 ml-2">
            <div className="flex flex-col items-end hidden sm:flex">
              <span className="text-xs font-bold text-slate-900">Admin SCAP</span>
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Supervisor do Sistema</span>
            </div>
            <img 
              src="/avatar.png" 
