  ...
  const columns = [
    {
      ...
      accessor: (log: LogEntry) => (
        <div className='flex items-center gap-3'>
          ...
          <div>
            <div
              className={`font-bold ${log.type === "Negado" ? "text-red-900" : "text-slate-900"}`}
            >
              {log.user}
            </div>
            <div
    ...
    },
    {
      ...
      accessor: (log: LogEntry) => (
        <span
          className={`inline-flex items-center px-4 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-widest ${
            log.type === "Entrada"
