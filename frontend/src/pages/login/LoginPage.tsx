    ...
    <main className='bg-surface font-body text-on-surface min-h-screen flex flex-col items-center justify-center relative px-6 py-12 overflow-hidden'>
      ...
      <div className='relative z-10 w-full max-w-[440px]'>
        ...
        <div className='mb-10 flex flex-col items-center text-center'>
          ...
          <h1 className='font-headline font-bold text-3xl tracking-tighter text-primary'>
            SCAP Admin
          </h1>
          <p className='text-on-surface-variant text-sm mt-2 font-medium tracking-tight'>
            CONTROLE DE ACESSO ARQUITETURAL
          </p>
        </div>
        ...
        <div className='bg-surface-container-lowest/80 architectural-blur p-10 rounded-xl shadow-[0px_24px_48px_-12px_rgba(25,28,30,0.08)] border border-white/50'>
          ...
          <form className='space-y-6' onSubmit={handleSubmit}>
            ...
            <div className='group'>
              <label
                className='font-label text-[10px] font-bold uppercase tracking-[0.1em] text-outline mb-1.5 block px-1'
                htmlFor='email'
              >
                E-mail
              </label>
            ...
            <div className='group'>
              <div className='flex justify-between items-end mb-1.5 px-1'>
                <label
                  className='font-label text-[10px] font-bold uppercase tracking-[0.1em] text-outline block'
                  htmlFor='password'
                >
                  Senha
                </label>
                <a
                  href='/recovery'
                  className='text-[10px] font-bold uppercase tracking-[0.1em] text-primary hover:opacity-70 transition-opacity'
                >
                  Esqueceu a senha?
                </a>
              </div>
              <div className='relative border-b border-outline-variant/30 focus-within:border-primary transition-colors'>
                ...
                />
                <div
                  className='absolute right-0 top-1/2 -translate-y-1/2 text-outline/30 cursor-pointer hover:text-outline transition-colors'
        ...
        <div className='mt-8 flex justify-center gap-6'>
          <a
            href='#'
            className='font-label text-[10px] font-bold uppercase tracking-[0.1em] text-outline hover:text-on-surface transition-colors'
          >
            Status do Sistema
          </a>
          <a
      ...
      <footer className='absolute bottom-0 w-full flex flex-col md:flex-row justify-between items-center px-8 py-6 opacity-30 group hover:opacity-100 transition-opacity pointer-events-none'>
        ...
        <div className='flex gap-6 mt-4 md:mt-0 pointer-events-auto'>
          <a
            className='font-body text-[10px] tracking-wide uppercase text-slate-400 hover:text-slate-900 transition-all'
            href='#'
          >
